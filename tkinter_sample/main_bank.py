...
from tkinter_sample.customer_account import CustomerAccount
from kivy.tkinter_sample.admin import Admin
import csv
...
class BankSystem(object):
    ...
    def load_bank_data(self):
        ...
        # --- Đọc dữ liệu khách hàng từ bảng Customers ---
        cursor.execute("SELECT * FROM Customers")
        for row in cursor.fetchall():
            # Giả sử row gồm: ID, FirstName, LastName, Address, PhoneNumber, Gender, AccNo, AccType, Balance
